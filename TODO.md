...
- [x] Add a note on the settings dialog when empty that you need a backend
- [x] On iOS, the buttons in the Settings configure dialog appear on two lines, try to fit them in one
